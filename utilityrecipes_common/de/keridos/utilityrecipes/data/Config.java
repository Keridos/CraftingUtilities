...
public class Config {
    ...
    private static void uncraftingConfig(Configuration config) {
    ...
    private static void smeltingConfig(Configuration config) {
    ...
    private static void IC2Config(Configuration config) {
